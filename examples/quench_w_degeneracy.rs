...
fn compute_energy_change(h0 : &Array2<Complex64>, h1 : &Array2<Complex64>, r : f64, ediag : &Array2<Complex64>, cvec : &Array2<Complex64>) -> Array1<Complex64>{
...
fn main() -> (){
    ...
    for (v1, d) in eval0.iter().zip(num_deg.iter()){
